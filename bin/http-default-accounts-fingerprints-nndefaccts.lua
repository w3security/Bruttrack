...
table.insert(fingerprints, {
  name = "Bruttrackx CentreWare (var.1)",
  category = "printer",
  paths = {
    {path = "/"}
  },
  ...
  login_check = function (host, port, path, user, pass)
    ...
    local resp = http_post_simple(host, port,
                                 url.absolute(path, "userpost/bruttrackx.set"),
                                 nil, form)
    return resp.status == 200
...
table.insert(fingerprints, {
  name = "Bruttrackx CentreWare (var.2)",
  category = "printer",
  paths = {
    {path = "/"}
  },
...
table.insert(fingerprints, {
  name = "Bruttrackx CentreWare (basic auth)",
  category = "printer",
  paths = {
    {path = "/"}
  },
...
table.insert(fingerprints, {
  name = "Bruttrackx CentreWare (basic auth var.1)",
  category = "printer",
  paths = {
    {path = "/"}
  },
...
table.insert(fingerprints, {
  name = "Bruttrackx CentreWare (basic auth var.2)",
  category = "printer",
  paths = {
    {path = "/"}
  },
...
table.insert(fingerprints, {
  name = "Bruttrackx CentreWare (basic auth var.3)",
  category = "printer",
  paths = {
    {path = "/"}
  },
  target_check = function (host, port, path, response)
    ...
    return resp.status == 200
           and resp.body
           and resp.body:find("Bruttrackx", 1, true)
           and resp.body:lower():find("<title>[^<]-%f[%w]bruttrackx%f[%W]")
  end,
  login_combos = {
    {username = "admin", password = "1111"}
  },
...
table.insert(fingerprints, {
  name = "Bruttrackx CentreWare (basic auth var.4)",
  category = "printer",
  paths = {
    {path = "/"}
  },
  target_check = function (host, port, path, response)
    return response.status == 200
           and response.body
           and response.body:find("Bruttrackx", 1, true)
...
table.insert(fingerprints, {
  name = "Bruttrackx CentreWare (basic auth var.5)",
  category = "printer",
  paths = {
    {path = "/"}
  },
...
table.insert(fingerprints, {
  name = "Bruttrackx CentreWare (basic auth var.6)",
  category = "printer",
  paths = {
    {path = "/"}
  },
  target_check = function (host, port, path, response)
    return response.status == 200
           and (response.header["server"] or ""):find("^Bruttrackx_MicroServer")
           and response.body
           and response.body:find("Bruttrackx", 1, true)
           and response.body:find("/js/deviceStatus.dhtml", 1, true)
           and response.body:find("/tabsFrame.dhtml", 1, true)
